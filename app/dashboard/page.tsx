import { BotIcon } from "lucide-react"; // Assuming you're using lucide-react
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4">
      <div className="relative max-w-2xl w-full">
        ...
        <div className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,_#f5f5f5_1px,_transparent_1px),_linear-gradient(to_bottom,_#f5f5f5_1px,_transparent_1px)] bg-[size:4rem_4rem] rounded-3xl"></div>
